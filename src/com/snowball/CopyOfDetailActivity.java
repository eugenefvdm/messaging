 ...
 * 
 */
public class CopyOfDetailActivity extends Activity implements AsyncResponse {
	...
	protected void onCreate(Bundle bundle) {
		...
		mBtnEnd.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				// TODO Migrate to string constant
...
//			values.put(TaskTable.COLUMN_END_ACTUAL, unixTime);
//		}
//		getContentResolver().update(todoUri, values, null, null);
//
//		cursor = getContentResolver().query(todoUri, mProjection, null, null, null);
//		cursor.moveToFirst();
//		String calendar_id = cursor.getString(cursor.getColumnIndexOrThrow(TaskTable.COLUMN_CALENDAR_ID));
//		cursor.close();
//		ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(4);
//		nameValuePairs.add(new BasicNameValuePair("action", action));
//		nameValuePairs.add(new BasicNameValuePair("calendar_id", calendar_id));
//		nameValuePairs.add(new BasicNameValuePair("value", String.valueOf(unixTime)));
//		doAsyncTask(nameValuePairs);
//	}
	...
	private void doAsyncTask(ArrayList<NameValuePair> nameValuePairs) {
		...
		asyncTask.delegate = CopyOfDetailActivity.this;
	...
	public void asyncProcessFinish(String output) {
		Toast.makeText(CopyOfDetailActivity.this, output, Toast.LENGTH_SHORT).show();
