...
import static za.co.snowball.jobtracker.CommonUtilities.DISPLAY_MESSAGE_ACTION;
import static za.co.snowball.jobtracker.CommonUtilities.EXTRA_MESSAGE;
...
public class JobListActivity extends FragmentActivity implements
...
//		GCMRegistrar.checkManifest(this);
	...
	private void doAsyncTask(ArrayList<NameValuePair> nameValuePairs) {
		...
		asyncTask.delegate = JobListActivity.this;
		asyncTask.execute(nameValuePairs);
	}

	@Override
	public void asyncProcessFinish(String output) {
		Toast.makeText(JobListActivity.this, output, Toast.LENGTH_SHORT).show();
	}
...
//	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.settings:
			Intent i = new Intent();
			i.setClass(JobListActivity.this, PrefsActivity.class);
