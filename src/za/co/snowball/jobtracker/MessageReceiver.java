...
public class MessageReceiver {
	...
	public static final String MESSAGING_SERVER_START = "start";
	public static final String MESSAGING_SERVER_RESUME = "resume";
	public static final String MESSAGING_SERVER_PAUSE = "pause";
	public static final String MESSAGING_SERVER_END = "end";
	...
	/*
	 * Some arb JSON to work with
	private String customFields = "customfields":
	[{
		"id":"11",
		"type":"support",
		"relid":"5",
		...
		"fieldtype":"dropdown",
		"description":"",
		"fieldoptions":"Bottelary,Hawekwa,Simonsberg",
		"required":"on",
		"value":"Bottelary,Hawekwa"
		
		},
		
		{\"id\":\"13\",\"type\":\"support\",\"relid\":\"5\",\"fieldname\":\"Survey Successful?\",\"fieldtype\":\"tickbox\",\"description\":\"\",\"fieldoptions\":\"\",\"required\":\"on\"}]";
	...
	private ContentValues convertMessageToContentValues(String action,
		...
		try {
			...
			if (action.equals("insertJob") || action.equals("update")) {
				...
				customfields = payload.getString("customfields");
...
//				}
		...
		values.put(Table.COLUMN_JOB_CUSTOM_FIELDS, customfields);
